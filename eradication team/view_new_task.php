            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped table-responsive table-hover">
                ...
                <tbody>
                  ...
                  <?php 
     $sql_load_district = "SELECT * FROM parents where city_id ='{$_SESSION['city_id']}' and status = 'approved'";
     ...
     while($row=mysqli_fetch_assoc($district_data))
        ...
        $status = $row['status'];
                        ...
                        <td><?php echo $mother_cnic; ?></td>
                         ...
                         <td><a href="view_children.php?frn=<?php echo $family_number; ?>&family=<?php echo $no_of_children; ?>"><?php echo $no_of_children; ?></a></td>
                         <td><?php echo $full_address; ?></td>
                         <td><?php echo $status; ?></td>
                         
                          <td>
              
                 <a href="status.php?family_number=<?php echo $family_number; ?>">Completed</a>
                  <?php 
