            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped table-responsive table-hover">
                ...
                <tbody>
                  ...
                  <?php 
     $sql_load_district = "SELECT * FROM parents where status !='pending'";
        ...
        $status = $row['status'];
                        ...
                        <td><?php echo $father_cnic; ?></td>
                         ...
                         <td><?php echo $status; ?></td>
                                ...
                                <td><a href="edit_parents.php?frn=<?php echo $family_number; ?>"><input type="button" class="btn btn-info" value="Edit" > </a></td>
