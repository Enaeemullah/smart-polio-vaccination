   ...
   if(empty($name)||empty($cnic)||empty($city)||empty($address)||empty($contact_number))
        {
         $_SESSION['info'] = "Please Fill All The Fields";
            header("location:edit_survey_team.php?er=1&id=$team_number");
            exit();
        }
        ...
        else
        {
            ...
            if($update_result)
            {
                 ...
                 $_SESSION['info']  =  "Survey Team information is updated successfully.";
                    header("Location: view_survey_team.php");
                    exit();
             }
            else
    ...
    <input type="text" name="contact_number" id="" class="form-control" value="<?php if(isset($contact_number)) echo $contact_number; ?>">  
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        <div class="hvr">
             <input type="submit" name="update_survey_team" class="btn btn-primary" value="Update Survey Team">
                        </div>
                    </div>
                </div>
