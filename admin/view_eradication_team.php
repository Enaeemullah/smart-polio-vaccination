            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped table-responsive table-hover">
                ...
                <tbody>
                  ...
                  <?php 
     $sql_load_district = "SELECT * FROM teams t join cities c where t.role_id='2' and t.city_id=c.city_id and t.type_id ='2'";
     ...
     while($row=mysqli_fetch_assoc($district_data))
        ...
        $contact_number = $row['contact_number'];
                        ...
                        <td><?php echo $contact_number; ?></td>
                         ...
                         <td><a href="edit_eradication_team.php?id=<?php echo $team_number; ?>"><input type="button" class="btn btn-info" value="Edit" > </a></td>
